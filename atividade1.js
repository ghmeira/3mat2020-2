...
novoVetor.push(estado1.nome)
novoVetor.unshift(estado2.nome)
novoVetor.splice(1, 0, estado3.nome)
novoVetor.splice(1, 0, estado4.nome)
novoVetor.splice(2, 0, estado5.nome)
novoVetor.splice(1, 0, estado6.nome)
